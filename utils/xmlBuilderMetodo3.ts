import { ConsultarNfseRpsEnvio } from '../types/nfse-metodos';
import { DOMParser } from 'xmldom';

export function buildConsultarNfseRpsXml(data: ConsultarNfseRpsEnvio): string {
  // Garantir que temos um objeto válido
  if (!data || !data.Prestador || !data.IdentificacaoRps) {
    throw new Error('Dados inválidos: Prestador e IdentificacaoRps são obrigatórios');
  }
