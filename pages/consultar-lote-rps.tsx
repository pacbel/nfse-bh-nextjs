...
const ConsultarLoteRps = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('/api/consultar-lote-rps', {
        ConsultarLoteRpsEnvio: formData
      });
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
      <Head>
        <title>Consultar Lote RPS - Sistema NFSe BH</title>
      </Head>
      ...
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
          <div className="max-w-md mx-auto">
            <div>
              <h1 className="text-2xl font-semibold text-center mb-6">Consultar Lote RPS</h1>
            </div>
                ...
                <div className="py-4 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  ...
                  <div className="pt-4">
                    <button
                      ...
                      disabled={loading}
                    >
                      {loading ? 'Consultando...' : 'Consultar Lote RPS'}
                    </button>
                  </div>
...
export default ConsultarLoteRps;
