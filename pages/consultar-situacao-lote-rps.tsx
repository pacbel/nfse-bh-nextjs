...
const ConsultarSituacaoLoteRps = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('/api/consultar-situacao-lote-rps', {
        ConsultarSituacaoLoteRpsEnvio: formData
      });
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
      <Head>
        <title>Consultar Situação Lote RPS - Sistema NFSe BH</title>
      </Head>
      ...
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
          <div className="max-w-md mx-auto">
            <div>
              <h1 className="text-2xl font-semibold text-center mb-6">Consultar Situação Lote RPS</h1>
            </div>
            <form onSubmit={handleSubmit}>
              <div className="divide-y divide-gray-200">
                <div className="py-4 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  ...
                  <div className="mb-4">
                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="protocolo">
                      Protocolo
                    </label>
                    <input
                      className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
...
export default ConsultarSituacaoLoteRps;
